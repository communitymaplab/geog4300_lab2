...
In the second part of this lab, you'll be answering this question: what are the preferred mean temperatures for two common tree species in Georgia? In the data folder, you'll find iNaturalist citizen science observations for live oaks and great rhododendrons. (Google them to find out more about these pretty trees.) These observations are in a single file named "gatree_obs_inat.csv" in the data folder.
